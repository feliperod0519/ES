...
curl -H "Content-Type:application/json" "localhost:9200/get-together/group/1?pretty" -d'{
  "name": "Denver Clojure",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/group/2?pretty" -d'{
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/group/3?pretty" -d'{
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/group/4?pretty" -d'{
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/group/5?pretty" -d'{
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/100" -d'{
  "host": ["Lee", "Troy"],
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/101" -d'{
  "host": "Sean",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/102" -d'{
  "host": "Daniel",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/103" -d'{
  "host": "Lee",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/104" -d'{
  "host": "Lee",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/105" -d'{
  "host": "Lee",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/106" -d'{
  "host": "Mik",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/107" -d'{
  "host": "Mik",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/108" -d'{
  "host": "Elyse",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/109" -d'{
  "host": "Andy",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/110" -d'{
  "host": "Andy",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/111" -d'{
  "host": "Andy",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/112" -d'{
  "host": "Dave Nolan",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/113" -d'{
  "host": "Dave",
...
curl -H "Content-Type:application/json" "localhost:9200/get-together/event/114" -d'{
  "host": "Yann",
...
curl "localhost:9200/_template/logging_index_all" -d'{
...
curl "localhost:9200/_template/logging_index" -d'{
    "template" : "logstash-*",
    "order" : 0,
    "settings" : {
        "number_of_shards" : 2,
...
curl -XPUT "http://$ADDRESS/myindex" -d'
{
    "mappings" : {
        "my_type" : {
            "dynamic_templates" : [{
...
curl -XPOST "http://$ADDRESS/november_2014_invoices" -d'{}'

echo
#curl -s -XPOST "http://$ADDRESS/december_2014_invoices" -d'
curl -XPOST "http://$ADDRESS/december_2014_invoices" -d'
{
    "mappings" :
    {
        "invoice" :
